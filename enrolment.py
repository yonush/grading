...
class Enrolment:
    ...
    def getMarks(self, code):
        ...
        """
        g = list(
            map(lambda g: g.assessments, filter(lambda g: g.code == code, self._grades))
        )
        return g[0]
    ...
    def show(self):
        return "\n".join(
            [
                f"Student ID: {self.student.studentid}",
